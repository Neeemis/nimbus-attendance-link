...
async function fix() {
  console.log('🚀 Finalizing hostels for ALL students...');
  try {
    await sql`UPDATE students SET hostel = 'Manimahesh Hostel' WHERE (hostel IS NULL OR hostel = '')`;
    console.log('✅ All hostels assigned.');
    await sql.end();
  } catch (err) {
